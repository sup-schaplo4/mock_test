"""
Universal 30-Question Generator Template
Generates 30 questions in 6 batches of 5 questions each

Usage:
1. Set TOPIC, OUTPUT_FILE, and import statements
2. Run: python generators/generate_[topic].py
"""
...
# Import will be overridden in specific generators
from prompts.number_series_prompts import (
    get_number_series_system_prompt as get_system_prompt,
    get_number_series_generation_prompt as get_generation_prompt
)
...
TOPIC = "Number Series"  # Change to "Number Series" or "Quadratic Equations"
OUTPUT_FILE = "number_series_questions.json"  # Change accordingly
...
# Difficulty distribution per batch (6E + 12M + 12H = 30)
BATCH_DIFFICULTY = [
    {"Easy": 5, "Medium": 0, "Hard": 0},    # Batch 1: 5E
    {"Easy": 1, "Medium": 4, "Hard": 0},    # Batch 2: 1E + 4M
    {"Easy": 0, "Medium": 5, "Hard": 0},    # Batch 3: 5M
    {"Easy": 0, "Medium": 3, "Hard": 2},    # Batch 4: 3M + 2H
    {"Easy": 0, "Medium": 0, "Hard": 5},    # Batch 5: 5H
    {"Easy": 0, "Medium": 0, "Hard": 5}     # Batch 6: 5H
]
