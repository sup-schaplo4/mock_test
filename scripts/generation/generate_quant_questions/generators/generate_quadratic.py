...
from prompts.quadratic_prompts import (
    get_quadratic_system_prompt as get_system_prompt,
    get_quadratic_generation_prompt as get_generation_prompt
)
...
TOPIC = "Quadratic Equations"  # Change to "Number Series" or "Quadratic Equations"
OUTPUT_FILE = "quadratic_equations_questions.json"  # Change accordingly
