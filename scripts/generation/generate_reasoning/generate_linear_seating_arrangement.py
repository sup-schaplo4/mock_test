"""
Linear Seating Arrangement Question Generator
...
# Question Metadata
TOPIC_NAME = "Linear Seating Arrangement"
REASONING_TOPIC = "Linear Seating"
MAIN_CATEGORY = "Puzzles & Seating Arrangements"
SUBJECT = "Reasoning"
EXAM_NAME = "RBI Grade B Phase 1"

# ============================================================================
# PROMPT TEMPLATE (Under 80 lines, no reference questions)
# ============================================================================

PROMPT_TEMPLATE = """# TASK: LINEAR SEATING ARRANGEMENT QUESTION GENERATOR

## CONTEXT
You are an expert in logical reasoning, tasked with creating high-quality Linear Seating Arrangement puzzles. These puzzles involve arranging people or objects in a row based on a set of conditions and test skills in logical deduction and constraint satisfaction.

## YOUR TASK
Please generate {batch_size} Linear Seating Arrangement questions.
...
### EASY
**Puzzle Structure:**
- 5-6 people in a single row
- 4-5 direct conditions
- Single-layer logic
- No complex interdependencies

### MEDIUM
**Puzzle Structure:**
- 6-8 people in single row OR two parallel rows (4+4)
...
### HARD
**Puzzle Structure:**
- 8-10 people in single row OR two parallel rows (5+5 or 6+4)
...
- linear_seating_arrangement_001
- linear_seating_arrangement_002
- And so on...

Start from ID: linear_seating_arrangement_{start_id:03d}
...
{{
  "questions": [
    {{
      "question_id": "linear_seating_arrangement_001",
...
def generate_linear_seating_questions():
    """
    Main function to generate linear seating arrangement questions
    """
    
    print("=" * 80)
    print("LINEAR SEATING ARRANGEMENT QUESTION GENERATOR")
    print("=" * 80)
    ...
    output_file = os.path.join(OUTPUT_BASE_DIR, f"linear_seating_questions_{timestamp}.json")
    error_log_file = os.path.join(OUTPUT_BASE_DIR, f"linear_seating_errors_{timestamp}.log")
    metadata_file = os.path.join(OUTPUT_BASE_DIR, f"linear_seating_metadata_{timestamp}.json")
        ...
        if result["success"]:
            ...
            if validation["valid"]:
                ...
                for idx, q in enumerate(questions):
                    expected_id = f"linear_seating_arrangement_{start_id + idx:03d}"
...
if __name__ == "__main__":
    generate_linear_seating_questions()
